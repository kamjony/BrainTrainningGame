...
public class Easy extends FragmentActivity implements KeyboardFragment.NumpadListener, ScoreFragment.ScoreListener {
    int Length = 10; //changes no. of questions
    int Count = 1;
    int nCorrect = 0;
    long timeElapsed = 0;
    String timeFormat = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EasyArray adapter = new EasyArray(this, listQuestions);
    ...
    public void onNumClick(int input) {
        try {
            ListView listView = (ListView) findViewById(R.id.listView);
            EasyArray adapter = (EasyArray) listView.getAdapter();
    ...
    public Question getQuizQuestion(int count) {
        ...
        switch (intOper) { //2 or 3 integers, create cases
            case 0: //+
                oper1 = '+';
                oper2 = '+';
