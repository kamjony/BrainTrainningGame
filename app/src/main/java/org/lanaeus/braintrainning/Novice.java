...
public class Novice extends FragmentActivity implements KeyboardFragment.NumpadListener, ScoreFragment.ScoreListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NoviceArray adapter = new NoviceArray(this, listQuestions);
    ...
    public void onNumClick(int input) {
        try {
            ListView listView = (ListView) findViewById(R.id.listView);
            NoviceArray adapter = (NoviceArray) listView.getAdapter();
