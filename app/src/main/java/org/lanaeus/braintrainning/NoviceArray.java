...
public class NoviceArray extends ArrayAdapter<Question> {

    public NoviceArray(Context context, ArrayList<Question> questions) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        txtquestion.setText(ques.getNoviceLine());
