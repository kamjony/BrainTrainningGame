...
public class Medium extends FragmentActivity implements KeyboardFragment.NumpadListener, ScoreFragment.ScoreListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MediumArray adapter = new MediumArray(this, listQuestions);
    ...
    public void onNumClick(int input) {
        try {
            ListView listView = (ListView) findViewById(R.id.listView);
            MediumArray adapter = (MediumArray) listView.getAdapter();
